...
class ReferExpressionDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        target = torch.zeros((self.max_region_num, 1)).float() # what max_region_num ??
        target[:mix_num_boxes] = mix_target[:mix_num_boxes] #target is.... a box?
